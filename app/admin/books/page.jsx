...
export default function AdminBooksPage() {
  ...
  const fetchBooks = async () => {
    try {
      const res = await fetch('http://apache-php/bookshop/api/books/index.php');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isEditing
        ? 'http://apache-php/bookshop/api/admin/books/update.php'
        : 'http://apache-php/bookshop/api/books/add.php';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://apache-php/bookshop/api/admin/books/delete.php?id=${id}`, {
        method: 'GET',
      });
      const data = await res.json();
      if (data.success) {
