...
export default function AdminBooksPage() {
  ...
  const fetchBooks = async () => {
    try {
      const res = await fetch('http://server/bookshop/api/books/index.php');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isEditing
        ? 'http://server/bookshop/api/admin/books/update.php'
        : 'http://server/bookshop/api/books/add.php';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://server/bookshop/api/admin/books/delete.php?id=${id}`, {
        method: 'GET',
      });
      const data = await res.json();
      if (data.success) {
