...
export default function AdminRegister() {
  ...
  const fetchAdmins = async () => {
    try {
      const res = await fetch('http://apache-php/bookshop/api/admin/admins.php');
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isEditing
      ? 'http://apache-php/bookshop/api/admin/update.php'
      : 'http://apache-php/bookshop/api/admin/register.php';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://apache-php/bookshop/api/admin/delete.php?id=${id}`, {
        method: 'GET',
      });
      const data = await res.json();
      if (data.success) {
