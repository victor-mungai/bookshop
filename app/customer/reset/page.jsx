...
function ResetPasswordFormInner({ token }) {
  ...
  useEffect(() => {
    ...
    fetch(`http://process.env.server/bookshop/api/customer/verify_token.php?token=${token}`)
      .then(res => res.json())
      .then(data => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('http://process.env.server/bookshop/api/customer/reset_password.php', {
      method: 'POST',
